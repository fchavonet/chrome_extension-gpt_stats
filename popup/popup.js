...
// Reset time chart to current week.
document.getElementById("today-time-week-btn").addEventListener("click", function () {
  weekOffsetTime = 0;
  updateWeeklyTimeChart();
});

// Reset prompt chart to current week.
document.getElementById("today-prompt-week-btn").addEventListener("click", function () {
  weekOffsetPrompt = 0;
  updateWeeklyPromptChart();
});
